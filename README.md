...
THIS IS STILL DEVELOPING and always will! PR/issues are very welcome. Be aware, this branch gets rebased onto main regularly.  
...
### rebaseing workflow
I rebase and add changes/deletions to: `cleanup base, and some changes`.
```sh
git pull --rebase
# rebase onto main (might create merge conflicts that need to be resolved)
git rebase main
# show the difference after rebase
git diff --name-status ORIG_HEAD
# create a fixup commit and autosquash it
