...
killall hyprswitch
sleep 0.5
hyprctl dispatch "hl.dsp.exec_cmd([[uwsm app -- hyprswitch init --show-title --size-factor 6 --workspaces-per-row 3 --custom-css $HOME/.config/hyprswitch/style.css >> ${logfile} 2>&1]])"
